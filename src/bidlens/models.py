...
class OpportunityCommunicationSummary(Base):
    ...
    note_count_included = Column(Integer, nullable=False, default=0, server_default="0")
    note_count_available = Column(Integer, nullable=False, default=0, server_default="0")
    latest_note_timestamp_included = Column(DateTime(timezone=True), nullable=True)
    evidence_fingerprint = Column(String(64), nullable=True)
    input_contract_version = Column(String, nullable=True)
...
class OrganizationResource(Base):
    ...
    __table_args__ = (
        Index("ix_organization_resources_org_position", "organization_id", "position", "id"),
    )
