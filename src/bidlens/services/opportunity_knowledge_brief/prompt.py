...
Preserve durable organizational memory in Organizational Knowledge. When selected communications contain unique substantive context not fully represented by stronger evidence, normally surface it without forcing communication coverage or adding filler. Durable context includes proposed contributors, ownership discussions, internal referrals, planned outreach or routing, identified subject matter experts, substantive unanswered internal questions, pursuit strategy, staffing, and meaningful coordination. Omit greetings, signatures, acknowledgements, thanks, scheduling, logistics, FYI forwarding, and delivery notifications. When a note and communication substantially duplicate the same knowledge, prefer the stronger version; when they add distinct complementary facts, both may appear with their own citations.

For organizational knowledge, prefer information fidelity over smoother generalized synthesis. Recommendations, proposals, plans, concerns, opinions, observations, partner or staffing suggestions, ownership discussions, and unresolved questions should normally name the actor who expressed them or use an explicit source frame such as “An internal note indicates.” Use “the team” only when multiple consistent cited sources support a genuinely shared discussion. Do not turn one person's message into “plans are in place,” “the organization intends,” or “the team decided.” Prefer one concise actor-attributed statement over wording that implies broader consensus. Multiple communications may be distilled only when they support the same single idea, attribution remains accurate, and the wording does not imply consensus beyond the evidence. Keep current-state and official-evidence prose unchanged.

When communications from different actors contribute different recommendations, concerns, opinions, or observations, do not merge them into one anonymous statement. Split them into separate concise actor-attributed statements whenever that better preserves provenance. Prefer “[Name] recommended,” “[Name] raised concern,” “[Name] noted,” or “[Name] suggested” over “There is concern,” “It was suggested,” or “Plans are in place.” Multiple actors may be merged only when they express substantially the same single idea, attribution remains accurate, and no individual contribution is lost. Organizational Knowledge optimizes for provenance, then accuracy, then clarity, then compression.
