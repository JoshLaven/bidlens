...
GUTS_PROMPT_VERSION = os.getenv("GUTS_PROMPT_VERSION", "guts-v10")
GUTS_MANIFEST_VERSION = os.getenv("GUTS_MANIFEST_VERSION", "guts-manifest-v1")
GUTS_OUTPUT_SCHEMA_VERSION = os.getenv("GUTS_OUTPUT_SCHEMA_VERSION", "guts-output-v2")
...
TEAM_SUMMARY_PROMPT_VERSION = os.getenv("TEAM_SUMMARY_PROMPT_VERSION", "team-summary-v1")
TEAM_SUMMARY_MAX_MESSAGES = int(os.getenv("TEAM_SUMMARY_MAX_MESSAGES", "50"))
TEAM_SUMMARY_MAX_MESSAGE_CHARS = int(os.getenv("TEAM_SUMMARY_MAX_MESSAGE_CHARS", "5000"))
TEAM_SUMMARY_MAX_TOTAL_MESSAGE_CHARS = int(os.getenv("TEAM_SUMMARY_MAX_TOTAL_MESSAGE_CHARS", "20000"))
TEAM_SUMMARY_MAX_NOTES = int(os.getenv("TEAM_SUMMARY_MAX_NOTES", "25"))
TEAM_SUMMARY_MAX_NOTE_CHARS = int(os.getenv("TEAM_SUMMARY_MAX_NOTE_CHARS", "3000"))
TEAM_SUMMARY_MAX_TOTAL_NOTE_CHARS = int(os.getenv("TEAM_SUMMARY_MAX_TOTAL_NOTE_CHARS", "6000"))
