...
class SalesforceConfigurationTests(unittest.TestCase):
    ...
    def test_integrations_page_exposes_only_configure_for_salesforce(self):
        ...
        self.assertEqual(html.count('id="microsoft-365"'), 1)
        self.assertIn("Connect Microsoft 365 for email and future Microsoft business services.", html)
        self.assertIn('href="/integrations/microsoft?org_id=', html)
        self.assertNotIn('id="outlook"', html)
        self.assertNotIn('id="teams"', html)
